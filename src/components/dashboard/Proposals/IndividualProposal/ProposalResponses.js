/**
 * This component renders the left hand side of the individual proposal page, which contains the client answers to the submit proposal questionnaire.
 * It is accessed via the individual proposal page by selecting an individual proposal.
