...
class EditStudentTeam extends React.Component {
  ...
  _handleUpdateStudentTeam = () => {  
    ...
    for (var j = 0; j < this.state.numProductLinks; j++) {
    ...
    for (var k = 0; k < this.state.numTechnologies; k++) {
    ...
    const newProduct = {
      ...
      activelyUsed: this.state.activelyUsed,
          ...
          <DialogContent>
            ...
            <TabContainer id="right-tabs-example" defaultActiveKey="first">
                <Row>
                    ...
                    <Nav variant="pills" className="flex-column">
                        <Nav.Item>
                        <Nav.Link eventKey="fourth">Metrics</Nav.Link>
                        </Nav.Item>
                    </Nav>
                    </Col>
                </Row>
                    ...
                    <TabContent>
                        <TabPane eventKey="second">
                            ...
                            <Table className={classes.table}>
                                <TableHead>
                                    <TableRow>
                                        <TableCell align="left" >Artefact Link</TableCell>
                                    </TableRow>
                                </TableHead>
                    ...
                    <TabContent>
                        <TabPane eventKey="third">
                            <Grid container spacing={8} alignItems="center">
                                <Grid item xs={3}>
                                    <div className={classes.studentTeamHeader}>
                                    Number of technologies utilised
                                    </div>
                                </Grid>
                                <Grid item xs={9}>
                                    <form className={classes.container} noValidate autoComplete="off">
                            ...
                            <Grid container spacing={8} style={{ marginLeft: 20, width: "98%" }}>
