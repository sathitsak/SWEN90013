    ...
    if (this.props.objType === "allClients") {
      ...
      fabButton = (
        <Chip
          ...
          icon={
            client.flag ? (
              <ErrorOutlinedIcon className={classes.chipFlag} />
            ) : (
              <FaceIcon />
            )
          }
    ...
    return (
      <div>
        ...
        >
              ...
              <Grid item xs={6}>
                <Paper className={classes.paper}>
                  <h1 style={{ color: "#094183" }}>
                    {this._concatenateNames(client.firstName, client.lastName)}
                    {flagIcon}
                  </h1>
                  <ClientDetails
                    email={client.email}
                    ...
                    secondaryContactName={this._concatenateNames(
                      client.secondaryContactFirstName,
                      client.secondaryContactLastName
                    )}
          ...
          <DialogActions>
            <EditClientModal client={client} objType={objType} objID={objID} />
