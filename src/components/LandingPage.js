                            ...
                            <figure className="figure figure--max">
                                <div className="embed figure__content">
                                    <iframe allowFullScreen="" frameBorder="0" height="315"
                                            src="//www.youtube.com/embed/8ZQWDeaTs3U" title="video player"
                                            width="560"></iframe>
                                </div>
                            </figure>
                        </section>
                        <section><h1>Our past projects</h1><p>We have worked on a wide range of web and mobile app
                            solutions, solving non-critical business problems in a variety of industries. Here is a
